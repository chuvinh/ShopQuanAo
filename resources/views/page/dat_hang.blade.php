			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="form-block">
						...
						<input type="text" id="address" name="address" placeholder="Địa chỉ" required value="{{Auth::user()->address}}">
					</div>
					<div class="form-block">
						<label for="phone">Điện thoại*</label>
						<input type="text" id="phone" name="phone" required placeholder="Số điện thoại" value="{{Auth::user()->phone}}">
					</div>
					...
					<div class="form-block">
						...
						<textarea id="notes" name="notes" required placeholder="Ghi chú"></textarea>
					</div>
				</div>
				@else
				<div class="col-sm-6">
					...
					<div class="form-block">
						<label for="adress">Địa chỉ*</label>
						<input type="text" id="address" name="address" placeholder="Địa chỉ" required value="">
					</div>
					<div class="form-block" style="display: none">
						<label for="name">Mã người giới thiệu</label>
						<input type="text" id="iduser" name="iduser" value="">
					...
					<div class="form-block">
						<label for="phone">Điện thoại*</label>
						<input type="text" id="phone" name="phone" placeholder="Số điện thoại" required value="">
					</div>
						...
						<div class="your-order-body" style="padding: 0px 10px">
							<div class="your-order-item">
								<div>
									...
									<!--  one item	 -->
									<div class="media">
										<img width="25%" src="image/{{$cart['item']['image']}}" alt="" class="pull-left">
